...
class JarvysDebugDashboard:
    ...
    def check_environment(self) -> Dict[str, Any]:
        ...
        required_vars = [
            ...
            "GITHUB_TOKEN", "GEMINI_API_KEY", "ANTHROPIC_API_KEY"
        ]
        ...
        required_files = [
            ...
            "src/jarvys_dev/main.py", "supabase/config.toml"
        ]
        ...
        try:
            import openai
            env_status["dependencies"]["openai"] = {"installed": True, "version": getattr(openai, "__version__", "unknown")}
        except ImportError:
            env_status["dependencies"]["openai"] = {"installed": False}
        
        try:
            import supabase
            env_status["dependencies"]["supabase"] = {"installed": True, "version": getattr(supabase, "__version__", "unknown")}
        except ImportError:
            env_status["dependencies"]["supabase"] = {"installed": False}
        
        try:
            import github
            env_status["dependencies"]["github"] = {"installed": True, "version": getattr(github, "__version__", "unknown")}
        except ImportError:
