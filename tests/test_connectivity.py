...
class TestSupabaseConnectivity:
    ...
    def test_supabase_key_format(self):
        ...
        assert key.startswith("eyJ"), "Supabase key should start with 'eyJ' (JWT format)"
    ...
    def test_supabase_connectivity(self):
        ...
        try:
            ...
            response = client.table("test_connectivity_check").select("*").limit(1).execute()
    ...
    def test_anthropic_connectivity(self):
        ...
        try:
            ...
            if response.status_code == 401:
                ...
                pytest.fail(f"Anthropic API returned status {response.status_code}")
...
class TestGCPConnectivity:
    ...
    def test_gcp_service_account_json_format(self):
        ...
        try:
            ...
            assert not missing_fields, f"Missing GCP SA fields: {missing_fields}"
            assert sa_data["type"] == "service_account", "GCP SA type should be 'service_account'"
    ...
    def test_gcp_connectivity(self):
        ...
        try:
            ...
            assert "private_key" in sa_data, "No private_key in GCP Service Account"
            assert "client_email" in sa_data, "No client_email in GCP Service Account"
