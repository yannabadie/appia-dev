...
try:
    from enhanced_system_prompts import (
        EnhancedPromptSystem,
        extract_system_prompt_for_grok,
    )
    ...
    def test_corrected_prompts():
        ...
        system_prompt = enhanced_prompts.get_grok_orchestrator_system_prompt(
            agent_type="DEV", collaboration_mode=True
        )
        ...
        checks = [
            (
                "Concis et direct",
                "PhD-level autonomous AI orchestrator" in system_prompt,
            ),
        ...
        system_prompt_direct = extract_system_prompt_for_grok(
            enhanced_prompts, "DEV", True
        )
