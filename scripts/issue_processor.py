...
class IssueProcessor:
    ...
    def add_labels_to_issue(self, issue, category: str):
        ...
        try:
            ...
            if new_labels:
                ...
                logger.info(
                    f"Added labels {new_labels} to issue #{issue.number}"
                )
        except Exception as e:
    ...
    def create_progress_comment(self, issue, status: str = "processing"):
        ...
        if status == "processing":
            comment_body = """🚀 **Early Launch Processing Started**
...
*This comment was automatically generated by the Early Launch automation system.*"""
            ...
            comment_body = """📊 **Issue Analysis Complete**
...
*This comment was automatically generated by the Early Launch automation system.*"""
        ...
        try:
            ...
            logger.error(
                f"Failed to add comment to issue #{issue.number}: {e}"
            )
    ...
    def log_to_supabase(self, issue_data: Dict):
        ...
        try:
            ...
            data = {
                ...
                "repository": issue_data.get(
                    "repository", "yannabadie/appia-dev"
                ),
            }

            _result = (
                self.supabase.table("jarvys_issue_processing")
                .insert(data)
                .execute()
            )
    ...
    def process_priority_issues(self) -> Dict:
        ...
        logger.info(
            f"✅ Processed {processed_count} issues, {error_count} errors"
        )
    ...
    def update_dashboard(self) -> Dict:
        ...
        try:
            issues = self.get_open_issues()
            priority_issues = [
                i for _i in issues if i.number in self.PRIORITY_ISSUES
            ]
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Early Launch Issue Processor"
    )
    parser.add_argument(
        "--mode",
