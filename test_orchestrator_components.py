...
def test_orchestrator_components():
    ...
    print(f"🔑 XAI API Key: {'✅ SET' if XAI_API_KEY and XAI_API_KEY != 'test-key' else '❌ MISSING'}")
    ...
    if grok_ok:
        ...
        try:
            ...
            if claude_ok:
                ...
                print(f"   ✅ Collaborative testing: {'SUCCESS' if confidence > 0.5 else 'NEEDS_IMPROVEMENT'}")
