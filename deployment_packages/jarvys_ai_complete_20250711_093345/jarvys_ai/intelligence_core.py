...
class IntelligenceCore:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.command_patterns = {
            'email': ['email', 'mail', 'message', 'outlook', 'gmail', 'envoyer', 'recevoir'],
            'file': ['fichier', 'file', 'dossier', 'folder', 'sauvegarder', 'ouvrir', 'créer'],
    ...
    async def analyze_command(self, command: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"📊 Analyse commande: {command_type} (conf: {analysis['confidence']:.2f})")
            return analysis
