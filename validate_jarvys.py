...
class JarvysValidator:
    ...
    def add_check(self, name: str, status: bool, message: str, is_critical: bool = True):
    ...
    def check_file_exists(self, file_path: str, description: str, critical: bool = True):
