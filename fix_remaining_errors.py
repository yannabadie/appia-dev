        ...
        for file in files:
            if file.endswith('.py'):
                ...
                try:
                    ...
                    unused_vars = [
                        'report', 'result', 'response', 'update', 'alert',
                        'source', 'success_criteria', 'expected_functions',
                        'total_time', 'client', 'supabase_client', 
                        'githubclient', 'parsed_data'
                    ]
        ...
        for file in files:
            if file.endswith('.py'):
                ...
                try:
                    ...
                    loop_vars = [
                        'i', 'job_name', 'check_name', 'expected_type',
                        'message_id'
                    ]
